...
class AutoriaSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://auto.ria.com/uk/search/?indexName=auto&categories.main.id=1&brand.id[0]=9&price.USD.lte=5000&price.currency=1&abroad.not=0&custom.not=1&size=100&page=0',
    ]
